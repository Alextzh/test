		...
		generPageHtml : function(config,enforceInit){
			...
			if(this.isShowFirstPageBtn){
				if(this.hasPrv){
					...
					str_first = '<span class="disabled" style="display:none;">'+this.lang.firstPageText+'</span>';
				}
			}
			...
			if(this.isShowLastPageBtn){
				if(this.hasNext){
					...
					str_last = '<span class="disabled" style="display:none;">'+this.lang.lastPageText+'</span>';
				}
			}
			var str = '';
			...
			var pagerHtml = '<div class="clear" style="display:inline-block;">';
			if(this.isWrapedPageBtns){
				pagerHtml += '<span class="pageBtnWrap">' + str_prv + str + str_next + '</span>'
			}else{
